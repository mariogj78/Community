<?php
/**
Description: This program is to delete a Supplier of the Community (Frac) from database. If no used or related in another information. 
...
Copyright (C) 2018 Mario González Jiménez.
	...
	DelSupplier.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
if($idSupplier != 0) {
	$resultStatus = $catalogStatus->delElementSupplier($idSupplier);
}
