<?php
/**
Description: This program is to generate a dropDown list of Status for Basic Table Catalog. Added by queryScript
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListStatus.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$catalog->showDropListFromTable("idStatus");
