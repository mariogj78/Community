<?php
/**
Description: This program is to generate a managed list of Supplier.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListSuppliers.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$catalog->showManagerTable("Supplier");
echo "<br>";
