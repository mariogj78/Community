<?php
/**
Description: This program is to generate a list of Car Brands  
@package	FracRB
@subpackage	Catalog
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListBrands.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$resultStatus = $catalogStatus->getCatalog("Brand");

$catalog = new Catalog;
$catalog->setResultSet($resultStatus);
$catalog->showDropListFromTable("idBrand");
