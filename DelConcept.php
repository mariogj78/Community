<?php
/**
Description: This program is to delete the Concept from database. If no used before. Need improvement for error nice handling :)
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	DelConcept.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
if($idConcept != 0) {
	$resultStatus = $catalogStatus->delElementConcept($idConcept);
}
