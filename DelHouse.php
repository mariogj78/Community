<?php
/**
Description: This program is to delete a House from the Community (Frac) from database. If no used or related in another information. 
...
Copyright (C) 2018 Mario González Jiménez.
	...
	DelHouse.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
if($idHouse != 0) {
	$resultStatus = $catalogStatus->delElementHouse($idHouse);
}
