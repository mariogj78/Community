<?php
/**
Description: This program is to generate a list of Car Colors.  
@package	FracRB
@subpackage	Car
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListColors.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$resultStatus = $catalogStatus->getCatalog("Color");

$catalog = new Catalog;
$catalog->setResultSet($resultStatus);
$catalog->showDropListFromTable("idColor");
