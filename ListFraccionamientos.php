<?php
/**
Description: This program is to generate a manager list of Communities added before.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListFraccionamientos.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
