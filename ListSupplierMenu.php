<?php
/**
Description: This program is to generate a dropDown list of Supplier.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListSupplierMenu.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$resultStatus = $catalogStatus->getCatalog("Supplier");

$catalog = new Catalog;
$catalog->setResultSet($resultStatus);
$catalog->showDropListFromTable("idSupplier");
