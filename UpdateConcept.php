<?php
/**
Description: This program is to modify the information of a Concept to the database and Return to the original caller page.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	UpdateConcept.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
if($idConcept != 0) {
	$resultStatus = $catalogStatus->updateElementConcept($idConcept,$name,$description,$idStatus);
}
