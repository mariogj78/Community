<?php
/**
Description: This program is to generate a list of Concepts for payments.
@package	FracRB
@subpackage	Settings
...
Copyright (C) 2018 Mario González Jiménez.
	...
	ListConcept.php is part of the MY WEB APPLICATION COMMUNITY MANAGER
...
$catalog->showManagerTable("Concept");
echo "<br>";
